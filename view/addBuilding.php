                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-12" style="width: 100%;">
                            ...
                            ?>
                                <form action="../controller/buildingControl.php" method="post">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control form-control-user" id="exampleFirstName" name="b_name" placeholder="Building Name">
                                                    </div>
                                                    <div class="col-sm-6">

                                                        <input type="text" class="form-control form-control-user" id="exampleFirstName" name="add" placeholder="Address">
